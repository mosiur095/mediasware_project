			...
			<table class="table">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<dl class="row mb-0" style="height: 80px; overflow: hidden;width:175px;" id="variant">
								...
								<dd class="col-sm-8">
									<dl class="row mb-0">
										<dt class="col-sm-6 pb-0" style="font-size: 10px;">Price : {{ $value->price}}</dt>
										<dd class="col-sm-6 pb-0" style="font-size: 10px;">InStock : {{$value->stock }}</dd>
									</dl>
								</dd>
							</dl>
